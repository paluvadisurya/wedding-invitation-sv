// Vendored from @vercel/analytics v2.0.1 (MIT License) — https://github.com/vercel/analytics
// Framework-agnostic build, copied here so this static site can `import` it with no bundler.
// src/queue.ts
var initQueue = () => {
  if (window.va) return;
